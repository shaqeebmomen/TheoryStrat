...
//    // match and team array instances
...
//    Team blue3;
//
//    // Two constructors one takes 6 team, other takes a match number
//
...
//            this.blue3 = null;
//        }
//        this.red1 = team.getTeam(red1);
//        this.red2 = team.getTeam(red2);
//        this.red3 = team.getTeam(red3);
//        this.blue1 = team.getTeam(blue1);
//        this.blue2 = team.getTeam(blue2);
//        this.blue3 = team.getTeam(blue3);
//
//    }
//
//    public MatchCard(String matchNum) {
//
//        this.red1 = match.getMatch(matchNum).getTeams().get(0);
//        this.red2 = match.getMatch(matchNum).getTeams().get(1);
//        this.red3 = match.getMatch(matchNum).getTeams().get(2);
//        this.blue1 = match.getMatch(matchNum).getTeams().get(3);
//        this.blue2 = match.getMatch(matchNum).getTeams().get(4);
//        this.blue3 = match.getMatch(matchNum).getTeams().get(5);
//
//    }
//
//
